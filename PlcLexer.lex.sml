...
\\035\033\005\005\005\005\031\005\030\029\028\027\026\024\005\023\
...
{fin = [(N 9)], trans = 1},
{fin = [(N 65)], trans = 0},
{fin = [(N 29),(N 65)], trans = 0},
{fin = [(N 47),(N 65)], trans = 0},
{fin = [(N 27),(N 65)], trans = 0},
{fin = [(N 7),(N 65)], trans = 9},
{fin = [(N 7)], trans = 9},
{fin = [(N 7),(N 36),(N 65)], trans = 9},
{fin = [(N 25),(N 65)], trans = 0},
{fin = [(N 23),(N 65)], trans = 0},
{fin = [(N 31),(N 65)], trans = 14},
{fin = [(N 58)], trans = 0},
{fin = [(N 49),(N 65)], trans = 16},
{fin = [(N 52)], trans = 0},
{fin = [(N 41),(N 65)], trans = 0},
{fin = [(N 60),(N 65)], trans = 19},
{fin = [(N 63)], trans = 0},
{fin = [(N 9),(N 65)], trans = 21},
{fin = [(N 9)], trans = 21},
{fin = [(N 17),(N 65)], trans = 0},
{fin = [(N 13),(N 65)], trans = 24},
{fin = [(N 55)], trans = 0},
{fin = [(N 45),(N 65)], trans = 0},
{fin = [(N 11),(N 65)], trans = 0},
{fin = [(N 15),(N 65)], trans = 0},
{fin = [(N 21),(N 65)], trans = 0},
{fin = [(N 19),(N 65)], trans = 0},
{fin = [(N 65)], trans = 31},
{fin = [(N 39)], trans = 0},
{fin = [(N 43),(N 65)], trans = 33},
{fin = [(N 34)], trans = 0},
{fin = [(N 4),(N 65)], trans = 35},
{fin = [(N 4)], trans = 35},
{fin = [(N 1)], trans = 0}])
end
...
| 11 => (PLUS(yypos,yypos))
| 13 => (MINUS(yypos,yypos))
| 15 => (MULTI(yypos, yypos))
| 17 => (DIV(yypos, yypos))
| 19 => (LPARENT(yypos, yypos))
| 21 => (RPARENT(yypos, yypos))
| 23 => (LBRACKET(yypos, yypos))
| 25 => (RBRACKET(yypos, yypos))
| 27 => (LBRACE(yypos, yypos))
| 29 => (RBRACE(yypos, yypos))
| 31 => (EQ(yypos, yypos))
| 34 => (INEQ(yypos, yypos))
| 36 => (UNDERSCORE(yypos, yypos))
| 39 => (AND(yypos, yypos))
| 4 => (lex())
| 41 => (SEMICOL(yypos, yypos))
| 43 => (NOT(yypos, yypos))
| 45 => (COMMA(yypos, yypos))
| 47 => (PIPE(yypos, yypos))
| 49 => (LESS(yypos, yypos))
| 52 => (LESSEQ(yypos, yypos))
| 55 => (ARROW(yypos, yypos))
| 58 => (DOUBARROW(yypos, yypos))
| 60 => (COLON(yypos, yypos))
| 63 => (DOUBCOLON(yypos, yypos))
| 65 => let val yytext=yymktext() in error("\n*** LEXER ERROR bad character ***\n"); 
raise Fail(" LEXER ERROR bad character "^yytext) end
| 7 => let val yytext=yymktext() in keyword(yytext, yypos, yypos) end
| 9 => let val yytext=yymktext() in CINT(strToInt(yytext), yypos, yypos) end
