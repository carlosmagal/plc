...
\\000"
 ...
 (1, 
"\005\005\005\005\005\005\005\005\005\034\036\005\005\005\005\005\
\\005\005\005\005\005\005\005\005\005\005\005\005\005\005\005\005\
\\034\032\005\005\005\005\030\005\029\028\027\026\025\023\005\022\
...
{fin = [(N 63)], trans = 0},
{fin = [(N 9),(N 65)], trans = 0},
{fin = [(N 17),(N 65)], trans = 0},
{fin = [(N 13),(N 65)], trans = 23},
{fin = [(N 55)], trans = 0},
...
{fin = [(N 65)], trans = 30},
{fin = [(N 39)], trans = 0},
{fin = [(N 43),(N 65)], trans = 32},
{fin = [(N 34)], trans = 0},
{fin = [(N 4),(N 65)], trans = 34},
{fin = [(N 4)], trans = 34},
{fin = [(N 1)], trans = 0}])
end
